...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Yoo, I'm BORBER 👋</h2>
                    <p>This is BORBER's OneDrive public directory listing. Feel free to download any files that you find useful. Reach me at: borber.drum [at] gmail [dot] com.</p>
                    <p><a href="https://borber.cn">Portfolio</a> · <a href="https://borber.cn">Blog</a> · <a href="https://github.com/borber">GitHub</a></p>
                  </div>`
